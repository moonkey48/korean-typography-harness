...
한마디로 **"한글 디자인 전문가의 규칙집을 AI에게 심어주는 부품 모음"**이에요.

보통 AI에게 "한글 홈페이지 만들어줘"라고 하면, AI는 외국 사이트를 기준으로 만들어서
**한글이 어딘가 어색하게** 나와요. 글씨가 빽빽하거나, 촌스럽거나, "AI가 만든 티"가 나죠.

이 도구를 설치하면, AI가 **한글에 맞는 정확한 규칙**(전문 디자이너들이 쓰는 수치)을
알아서 지키면서 만들어 줘요. 여러분은 그냥 한국어로 부탁만 하면 됩니다.
